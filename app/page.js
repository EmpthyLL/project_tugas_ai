...
export default function VoiceCloner() {
  ...
  return (
    <section className="w-full min-h-screen flex items-center justify-center bg-gradient-to-br from-[#1a1a40] via-[#3f0d85] to-[#8a2be2] transition-all duration-700">
      {/* Hapus content box, hanya menampilkan tab */}
      <Tabs
        value={currentTab}
        onValueChange={(val) => {
